if (localStorage.getItem('list blog 2019-02-02 19:15:45 +0800') != null){
	$('.list-group').html(localStorage.getItem('list blog 2019-02-02 19:15:45 +0800'))
}
...
$('.acak').click(function(){
	...
	localStorage.setItem('list blog 2019-02-02 19:15:45 +0800', $('.list-group').html())
})
